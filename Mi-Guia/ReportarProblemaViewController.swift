...
class ReportarProblemaViewController: UIViewController {
    ...
    @IBOutlet weak var btnLeyendaReportar: UIButton!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        btnLeyendaReportar.backgroundColor = UIColor(red:0.70, green:0.45, blue:0.27, alpha:1.0)
    ...
    func insertaProblema(){
        ...
        mailUser = mail.text! + " iOS-comipems-free"
        problemaReporte = problema.text!
