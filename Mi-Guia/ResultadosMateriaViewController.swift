...
class ResultadosMateriaViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var leyendaResultadosUno: UILabel!
    
    @IBOutlet weak var leyendaResultadosDos: UILabel!
    
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        leyendaResultadosUno.textColor = UIColor(red:0.70, green:0.45, blue:0.27, alpha:1.0)
        
        leyendaResultadosDos.textColor = UIColor(red:0.70, green:0.45, blue:0.27, alpha:1.0)
        ...
        mensajeResultados.text = "Obtuviste \(resultadoFinal!) de \(preguntasRealizadas!) preguntas"
