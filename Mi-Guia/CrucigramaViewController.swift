...
class CrucigramaViewController: UIViewController {
    ...
    @IBOutlet weak var playPregunta: UIBarButtonItem!
    
    @IBAction func preguntaPlay(_ sender: Any) {
    ...
    @IBAction func preguntaStop(_ sender: Any) {
    ...
    @IBAction func tooltipPlay(_ sender: Any) {
    ...
    @IBAction func tooltipStop(_ sender: Any) {
    ...
    func siguienteShowPreguntaNext() {
        ...
        audioPregunta = "/"+arrayPreguntas[contadorPregunta]["audiopregunta"]!
        audioTooltip = "/"+arrayPreguntas[contadorPregunta]["audiotooltip"]!
        ...
        buttonCalificar.backgroundColor = UIColor(red:0.00, green:0.45, blue:0.81, alpha:1.0)
        buttonCalificar.setTitle("Calificar", for: .normal)
        ...
        buttonAyuda.backgroundColor = UIColor(red:0.00, green:0.45, blue:0.81, alpha:1.0)
        buttonAyuda.setTitle("Ayuda", for: .normal)
    ...
    @objc func buttonActionCalificar(sender: UIButton!) {
        ...
        if(calificaFrase<=2){
            ...
            titulo = "Incorrecta"
            mensaje = "Intenta con otra pregunta"
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { action in
            ...
            case .default:
                ...
                for view in self.scrollView.subviews{
                    if(!view.contains(self.tituloMateria as! UIFocusEnvironment)){
    ...
    @IBOutlet weak var navigationTooltipPlay: UINavigationBar!
    
    func ayudaTooltip(){
        
        for view in tooltip.subviews{
            if(!view.contains(navigationTooltipPlay)){
                view.removeFromSuperview()
            }
        }
        ...
        var scrollView: UIScrollView!
        scrollView = UIScrollView(frame: CGRect(x: 0, y: 50.0, width: tamanoPantallaXTooltipp, height: tamanoPantallaYTooltipp))
